...
public class BinaryTree {
    ...
    private int numLevels(BinaryTreeNode root) {
        if (root == null)
            return 0;
        int numLevelsLeft = numLevels(root.left);
        int numLevelsRight = numLevels(root.right);
        return Math.max(numLevelsLeft, numLevelsRight) + 1;
    }
     ...
     * and print all the node values. For a tree below,
     * it should print 5 2 10 18 29 35 3 1 6 5 9
     *
     *                       5
     *             2                   10
     *         18     29            35     3
