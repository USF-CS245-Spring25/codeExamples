...
public class Graph {
    ...
    public void printNeighbors(int vertexId) {
        Edge curr = graph[vertexId]; // the head of the linked list of outgoing edges for this vertex
        while (curr != null) {
